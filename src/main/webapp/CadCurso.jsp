      ...
      <div id="main">
        <div class="block" id="block-forms">
          ...
          <div class="content">
            ...
            <div class="inner">
            	<%=mensagem%>
              <form id="FrmCurso" name="FrmCurso" action="Curso" method="POST" class="form">
        	  ...
        	  <input type = "hidden" id="id" name = "id" <% /* Caso de edicão if (pergunta != null && pergunta.getId() != null ) { out.print(" value = '" + pergunta.getId() + "'"); } */ %>>
                ...
                <div class="group">
                   ...
                   <input type="text" id="sigla" name="matricula" <% /// if (pergunta != null && pergunta.getPergunta() != null ) { out.print(" value = '" + pergunta.getPergunta() + "'"); } %> class="text_field" />
                </div>
                <div class="group navform wat-cf">
                  ...
                  <a class="text_button_padding link_button" href="listarCursos.jsp"><%=Constantes.CANCELAR%></a>
                </div>
              </form>
            </div>
          </div>
